...
1. **Input**: the `name` column of the supplied AppointmentTitle reference extract (a CSV in the sibling checkout `../ctam-jomockapi/joh-elinks-api/ReferenceData/`). It holds 194 rows, all with distinct names. Every other column is ignored (FR-021).
