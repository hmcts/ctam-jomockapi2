...
A request using any HTTP method other than `GET` against `/api/v5/healthcheck` MUST NOT invoke this endpoint's success behaviour (spec.md FR-008); Spring's default method-not-allowed handling for the path applies.
